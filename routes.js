...
router.get('/mispedidos/:idusuario',(req,res) => {
    ...
    mysql.query(`select p.codigo as numpedido,n.Nombre as nombrenegocio,p.valor as valortotal,date(p.fechaing) as fecha,case when p.entregado = 0 then 'No' else 'Si' end as entregado, n.latitud, n.longitud
    from pedido_enc p
